...
export const propertyData = {
  ...
  headline: "Your Friendly Stay in Negombo",
  summary: "Looking for a comfortable, social, and affordable place to stay in Negombo? Mulberry Living is a relaxed home base for travelers, backpackers, couples, digital nomads, and small groups.",
...
You'll also enjoy free Wi-Fi, parking, and a rooftop space to unwind with a view. Housekeeping is available on request, and laundry services are available at an additional charge.`,
  ...
  isVisible: true,
  gallery: [
    { path: "/placeholder.svg", alt: "Mulberry Living exterior" },
    { path: "/placeholder.svg", alt: "Private room with ensuite" },
    { path: "/placeholder.svg", alt: "Dorm room" },
    { path: "/placeholder.svg", alt: "Two-bedroom apartment" },
    { path: "/placeholder.svg", alt: "Rooftop with view" },
    { path: "/placeholder.svg", alt: "Common area" },
  ],
  contact: {
...
export const roomTypes = [
  {
    id: "private",
    name: "Ensuite Private Rooms",
    subtitle: "8 Rooms",
    description: "Privacy with a hostel-friendly feel. Perfect for couples, solo travelers, and digital nomads who want comfort without the hotel price tag.",
    features: [
      "Ensuite bathroom with hot water",
      "Comfortable bed and fresh linen",
      "Air conditioning",
      "Free Wi-Fi",
      "Mini bar facility",
      "Balcony"
    ],
    bestFor: "Post-flight recovery, relaxed workdays, and easy beach-town evenings."
  },
  {
    id: "dorm",
    name: "Mixed Dorm Rooms",
    subtitle: "2 Rooms & 3 Bunk Beds Each",
